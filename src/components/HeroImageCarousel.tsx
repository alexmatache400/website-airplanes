...
const CAROUSEL_IMAGES = [
  { src: '/landingPaige/carousel-setups/carousel-image-1.jpg', alt: 'Professional flight simulator setup 1' },
  { src: '/landingPaige/carousel-setups/carousel-image-2.png', alt: 'Professional flight simulator setup 2' },
  { src: '/landingPaige/carousel-setups/carousel-image-3.png', alt: 'Professional flight simulator setup 3' },
  { src: '/landingPaige/carousel-setups/carousel-image-4.png', alt: 'Professional flight simulator setup 4' },
  { src: '/landingPaige/carousel-setups/carousel-image-5.png', alt: 'Professional flight simulator setup 5' },
];
